...
some rules. This is described in the <Link to="/full_potential_css">Full Potential CSS Theory</Link>.
      ...
      <p>
      Tools for optimization/parameter estimation, sensitivity analysis, and statistical analysis with presentation of results from multiple simulations of a stochastic model are included in StochSD.
      </p>
      <p>
...
2022. 
      ...
      <p>
        <i>Updated: 2024-03-09 <span className="subtle">(yyyy-mm-dd)</span></i>
      </p>
    </div>
  );
};
